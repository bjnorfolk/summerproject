...
stars = Table.read("bariumdata.fits")
L = len(stars)
N=1
...
for index, star in enumerate(stars):
  ...
  icrs = coord.ICRS(ra=star["ra_1"] * u.deg,
                  ...
                  radial_velocity=-star["z_1"]*299792.458*u.km/u.s)
  """
  ...
  fig.savefig('Orbits/BariumStars/' +str(star["id"]) +'.png')
  plt.close("all")
...
stars.write("completedynamicsbarium.fits", overwrite=True)

del stars["parallax posterior pdf"]
stars.write("completedynamicsbarium.csv", overwrite=True)
