...
lhs = 5400
separator, offset = (2, 0.10)
ax.axhline(separator, c="#666666", linestyle=":", zorder=-1, lw=1)
ax.text(lhs, separator - offset, r"Intrinsic/extrinsic",
        verticalalignment="bottom", fontdict=dict(color="#666666"))
ax.text(lhs, separator + offset, r"Extrinsic", 
        verticalalignment="top", fontdict=dict(color="#666666"))
