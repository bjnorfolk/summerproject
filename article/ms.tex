...
\toprule
2MASSID             & RA (hms         & DEC (hms)        & Vr (km/s) & S/N & $\rm T_{\rm eff}$ (K) & Log g & {[}Fe/H{]} & {[}$\alpha$/H{]} & $\chi^2$  \\ \midrule
