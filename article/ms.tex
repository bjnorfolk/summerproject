...
% Could be removed:
%Also, synonymous to our s-process candidates, synthesised sodium is brought to the surface of giants via the first dredge-up, therefore, these candidates may display sodium enhancement without mass transfer from a TP-AGB star. 

%Furthermore, this suggests other enhancements including our 5 sodium and 178 carbon enhanced Barium stars exist through TP-AGB companion pollution.
