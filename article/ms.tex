...
In our research we analysed 272 Barium canidates amoung the 454,180 stellar sample produced by \citet{ho2017} and with GAIA determined the galactic motions for 21 out the 272 canidates.

\section{Observations, Target Selection}
The low-resolution spectra of our stars were obtained from the \textit{Cannon} fits predictive model implemented by \citet{ho2017} on the LAMOST (Large Sky Area Multi-Object Fibre Spectroscopic Telescope) DR2 release \citep{luo2015}. The resulting 454,180 stellar data set contains infered $T_{eff}$, $log g$, $[Fe/H]$, and [$\alpha/M$] values.  
